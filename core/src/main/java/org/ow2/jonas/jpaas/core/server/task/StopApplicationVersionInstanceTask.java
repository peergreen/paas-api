...
public class StopApplicationVersionInstanceTask extends AbstractTask implements Task {

    private Future<ApplicationVersionInstance> instance;


    public static final String TASK_NAME = "task:stop-application";

    public StopApplicationVersionInstanceTask(Future<ApplicationVersionInstance> instance, String baseUrl) {
